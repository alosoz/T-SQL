...
-- Task 2
-- 
-- Write a SELECT statement to retrieve the empid, firstname, and lastname columns from the HR.Employees table and the calendardate column 
-- from the HR.Calendar table.
--
...
-- Result.txt. 
--
-- What is the number of rows returned by the query? There are nine rows in the HR.Employees table. Try to calculate the total number of rows 
